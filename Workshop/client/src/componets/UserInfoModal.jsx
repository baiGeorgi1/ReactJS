...
const UserInfoModal = ({ userId, onClose }) => {
  const [user, setDetail] = useState({});

  useEffect(() => {
    userAPI.getUserInfo(userId).then((result) => setDetail(result));
  }, [userId]);
  return (
        ...
        <div className="detail-container">
          ...
          <div className="content">
            ...
            <div className="user-details">
              ...
              <p>
                Created on: <strong>{dateFormat(user.createdAt)}</strong>
              </p>
              <p>
                Modified on: <strong>{dateFormat(user.updatedAt)}</strong>
              </p>
            </div>
          </div>
        </div>
